...
const MOCK_CHAINS: Record<string, Chain> = {
...
const getChain = (name: string): Chain => {
  if (name.startsWith('Polkadot Asset')) return MOCK_CHAINS['Polkadot Asset Hub'];
  if (name.startsWith('Kusama')) return MOCK_CHAINS['Kusama'];

  return MOCK_CHAINS['Polkadot'];
};
